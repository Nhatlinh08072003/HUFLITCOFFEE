...
public partial class HuflitcoffeeContext : DbContext
{
    ...
    => optionsBuilder.UseSqlServer("Server=UINLAN;Database=HUFLITCOFFEE;MultipleActiveResultSets=true;User ID=admin;Password=asdasd;Trusted_Connection=True;TrustServerCertificate=Yes;Connect Timeout=60");
